...
class StreamingExample:
    ...
    #def move1(self):
        #self.drone(moveBy(0, 0, -0.6, 0)).wait(10)
        #self.drone(moveBy(1, 0, 0, 0)).wait(10)
        #self.drone(moveBy(0, 0, 0.6, 0)).wait(10)
        
        #self.drone(moveBy(3, 0, 0, 0)).wait(10)
        #self.drone(moveBy(0, 0, 0, 1.571)).wait(10)
        #self.drone(moveBy(2, 0, 0, 0)).wait(10)
        #self.drone(moveBy(0, 0, 0, 1.571)).wait(10)

    #def move2(self):
        #self.drone(moveBy(0, 0, -0.8, 0)).wait(10)
        #self.drone(moveBy(0.8, 0, 0, 0)).wait(10)
        #self.drone(moveBy(0, 0, 0.8, 0)).wait(10)
        #self.drone(moveBy(0.8, 0, 0, 0)).wait(20)
        #self.drone(Landing()>> FlyingStateChanged(state="hovering", _timeout=10)).wait()
        #self.drone(moveBy(0, 0, 0, -1.571)).wait(20)

    def move3(self):
        self.drone(moveBy(0, 0, -1, 0)).wait(10)
        self.drone(moveBy(0.5, 0, 0, 0)).wait(10)
        self.drone(moveBy(0, 0, 0, -1.571)).wait(20)
        self.drone(moveBy(0.5, 0, 0, 0)).wait(10)
        self.drone(moveBy(0, 0, 1, 0)).wait(10)
    ...
    def move4(self):
        ...
        self.drone(moveBy(1, 0, 0, 0)).wait(10)
        self.drone(moveBy(0, 0, 1, 0)).wait(10)
        self.drone(moveBy(1.5, 0, 0, 0)).wait(20)
        self.drone(moveBy(0, 0, 0, 1.571)).wait(20)
    ...
    def move5(self):
        ...
        self.drone(moveBy(0.5, 0, 0, 0)).wait(10)
        self.drone(moveBy(0, 0, 0, 1.571)).wait(20)
        self.drone(moveBy(0.5, 0, 0, 0)).wait(20)
        self.drone(moveBy(0, 0, 1, 0)).wait(10)

    def move6(self):
        self.drone(moveBy(0, 0, -1, 0)).wait(10)
        self.drone(moveBy(5, 0, 0, 0)).wait(10)
   ...
   # print(list(enumerate(test1,1)).tostring())
    ...
    # get their pose if camera_params is available
        ...
        #print()
            ...
            vr=0.0005*(img.shape[1]/2-marker_x)
            ...
            if camera_params is not None and detection.tag_id is count:
                ...
                #    self.drone(moveBy((distance-3)/100, 0, 0, 0)).wait()
                 ...
                 #       self.move2()
                ...
                elif (distance > 2 and distance < 70):
                    count=count+1
                    self.drone.piloting_pcmd(0, 0, 0, 0, 0.0)
                    time.sleep(0.2)
                    ...
                    alt1=alt['altitude']
                    self.drone(
    moveBy(0, 0, (alt1+0.11)-(1.5), 0)
    >> FlyingStateChanged(state="hovering", _timeout=5)
).wait()
                    self.drone(
    moveBy((distance-7)/100, 0, 0, 0)
    >> FlyingStateChanged(state="hovering", _timeout=5)
).wait()
                    print("start")
                    time.sleep(3)
